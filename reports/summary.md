...
|----------|----------|---------|------|-----|-----------------|
| info | swagger-api | http://juice:3000/api-docs/swagger.yaml | - | ['cwe-200'] | - |
| info | external-service-interaction | http://juice:3000 | - | ['cwe-918', 'cwe-406'] | CVE-2018-16487, CVE-2018-3721, CVE-2019-1010266, CVE-2019-10744, CVE-2020-28500, CVE-2021-23337 |
| info | missing-sri | http://juice:3000 | - | - | CVE-2016-1000223 |
| info | robots-txt | http://juice:3000/robots.txt | - | - | - |
| info | fingerprinthub-web-fingerprints | http://juice:3000 | - | ['cwe-200'] | - |
| info | http-missing-security-headers | http://juice:3000 | - | - | - |
| info | http-missing-security-headers | http://juice:3000 | - | - | - |
| info | http-missing-security-headers | http://juice:3000 | - | - | - |
| info | http-missing-security-headers | http://juice:3000 | - | - | - |
| info | http-missing-security-headers | http://juice:3000 | - | - | - |
...
| info | http-missing-security-headers | http://juice:3000 | - | - | - |
| info | http-missing-security-headers | http://juice:3000 | - | - | - |
| info | x-recruiting-header | http://juice:3000 | - | - | CVE-2016-1000223, CVE-2016-4055, CVE-2017-18214, CVE-2022-24785 |
| medium | prometheus-metrics | http://juice:3000/metrics | - | ['cwe-200'] | - |
| info | addeventlistener-detect | http://juice:3000 | - | ['cwe-79'] | - |
| info | owasp-juice-shop-detect | http://juice:3000 | - | - | CVE-2024-37890 |
| info | security-txt | http://juice:3000/.well-known/security.txt | - | - | - |
| info | robots-txt-endpoint | http://juice:3000/robots.txt | - | - | - |
...
- + HEAD /172.24.0.2.pem: Potentially interesting backup/cert file found.
...
- + HEAD /172.24.0.2.tar.bz2: Potentially interesting backup/cert file found.
...
- + HEAD /172.24.0.2.tar.lzma: Potentially interesting backup/cert file found.
...
- + HEAD /172.24.0.2.tgz: Potentially interesting backup/cert file found.
- + HEAD /dump.pem: Potentially interesting backup/cert file found.
- + HEAD /172.24.0.2.jks: Potentially interesting backup/cert file found.
...
- + HEAD /172.24.0.2.alz: Potentially interesting backup/cert file found.
- + HEAD /172.24.0.2.tar: Potentially interesting backup/cert file found.
...
- + HEAD /172.24.0.2.egg: Potentially interesting backup/cert file found.
- + HEAD /archive.egg: Potentially interesting backup/cert file found.
- + HEAD /172.24.0.2.cer: Potentially interesting backup/cert file found.
...
- + HEAD /172.24.0.2.war: Potentially interesting backup/cert file found.
...
- Nuclei ↔ Trivy correlated issues: 4
